...
{
    /// <summary>
    ///     A Repositor for all asserts required by renderings
    /// </summary>
    public class AssetRepository
    {
        ...
        {
            this.Add(new AssetRequirement(AssetType.JavaScript, null, script, script.GetHashCode().ToString()), preventAddToCache);
        }
        ...
        {
            this.Add(new AssetRequirement(AssetType.Css, null, styling, styling.GetHashCode().ToString()), preventAddToCache);
        }
    }
}