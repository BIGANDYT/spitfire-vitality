    ...
    public struct Templates
    {
        ...
        public struct PageAssets
        {
            ...
            public struct Fields
            {
                ...
                public static ID JavascriptCodeBottom => new ID("{B3BA9EA9-D0A1-49DF-9F4B-28FA5D353DC8}");
                public static ID CssCode => new ID("{06A96EFC-F2E5-45C3-A7DC-4DDDFA366CC0}");
                public static ID InheritAssets => new ID("{F19E8A50-9950-4861-9E66-9598A1898E71}");
            }
        }
    }
}