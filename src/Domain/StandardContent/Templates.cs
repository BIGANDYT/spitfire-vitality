...
namespace Spitfire.StandardContent
{
    public struct Templates
    {
        ...
        public struct HasBodyText
        {
            public static ID ID => new ID("{F15AFC99-281E-48DF-B333-91033622651A}");
            public struct Fields
            {
                public static ID BodyText => new ID("{D74F396D-5C5E-4916-BD0A-BFD58B6B1967}");
            }
        }
        public struct HasContentImage
        {
            public static ID ID => new ID("{640B55DD-405B-489C-A4AF-E328588EFE05}");
            public struct Fields
            {
                public static ID ContentImage => new ID("{9492E0BB-9DF9-46E7-8188-EC795C4ADE44}");
            }
        }
    }
}
